...
class CstModelCfg:
    ...
    DEF_COMPLETED_REPORT_TEMPERATURE = 0.01
    DEF_COMPLETED_REPORT_TOP_P = 0.95
    DEF_COMPLETED_REPORT_MAX_TOKENS = 300
    DEF_TIME_OUT = 120
    SYS_ROLE = "system"
    USR_ROLE = "user"
